...
My long-term goal is to develop AI methods that enable AI agents to have the ability to give rise to new concepts by thinking and explaining phenomena that they have not been exposed to. Broadly, I want to understand how people integrate perception and reasoning to understand the world around them. I am also actively learning about causality in deep learning, continual learning, language grounding, reinforcement learning and fariness in AI. If you have a project idea you'd like to discuss, let's get in touch!

Internships at several organizations have helped me gain solid ground in implementing deep learning based models. I’ve successfully completed projects using deep learning architectures like object detection pipelines, super-resolution networks, graph neural networks, auto-encoders, and autoregressive networks and transformers. I’m also well-acquainted with machine learning algorithms like discriminant analysis, stochastic regression, and decision trees. 

<br> Work apart, I love hiking! I really enjoy meeting people from different parts of the world, and learn about their culture. I’m an outgoing introvert. I am a huge foodie and love trying different cuisines. I listen to soft pop, and countryside music. In my free time, if I am not sleeping, I'm either scrolling Twitter or reading a novel! <br>
